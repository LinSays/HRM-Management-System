...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <span  id="print" class="btn btn-success btn-sm" onclick="print_summary(event.target);">Print</span>
            <a href="javascript:;"
...
<script>
    ...
    function exportCsv(_this) {
        ...
        var month = $('#month').val();
        var userId = $('#user_id').val();
        var url = '{!! route('admin.attendances.summary.export_csv', [':year',':month',':userid',]) !!}';
        url = url.replace(':userid', userId);
        url = url.replace(':month', month);
        url = url.replace(':year', year);
    ...
    function exportPdf(_this) {
        ...
        var month = $('#month').val();
        var userId = $('#user_id').val();
        var url = '{!! route('admin.attendances.summary.export_pdf', [':year',':month',':userid',]) !!}';
        url = url.replace(':userid', userId);
        url = url.replace(':month', month);
        url = url.replace(':year', year);
        window.location.href = url;
    ...
    function print_summary(_this){
        ...
        var url = '{!! route('admin.attendances.summaryPrintData') !!}';
        console.log(url);
