        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('attendances/mark/{id}/{day}/{month}/{year}', ['uses' => 'ManageAttendanceController@mark'])->name('attendances.mark');
                    //attendance_exports-summary
                Route::get('attendances/summary/export_csv/{year}/{month}/{userId}', ['uses' => 'ManageAttendanceController@summary_csv'])->name('attendances.summary.export_csv');
                Route::get('attendances/summary/export_pdf/{year}/{month}/{userId}', ['uses' => 'ManageAttendanceController@summary_pdf'])->name('attendances.summary.export_pdf');
                Route::post('attendances/summaryPrintData/', ['uses' => 'ManageAttendanceController@summaryPrintData'])->name('attendances.summaryPrintData');
                    //attendance_exports-member
                Route::get('attendances/member/export_csv/{startDate}/{endDate}/{userId}', ['uses' => 'ManageAttendanceController@member_csv'])->name('attendances.member.export_csv');
                Route::get('attendances/member/export_pdf/{startDate}/{endDate}/{userId}', ['uses' => 'ManageAttendanceController@member_pdf'])->name('attendances.member.export_pdf');
                Route::post('attendances/memberPrintData/', ['uses' => 'ManageAttendanceController@memberPrintData'])->name('attendances.memberPrintData');
                    //attendance_exports-date
                Route::get('attendances/date/export_csv/{date}', ['uses' => 'ManageAttendanceController@date_csv'])->name('attendances.date.export_csv');
                Route::get('attendances/date/export_pdf/{date}', ['uses' => 'ManageAttendanceController@date_pdf'])->name('attendances.date.export_pdf');
                Route::post('attendances/datePrintData/', ['uses' => 'ManageAttendanceController@datePrintData'])->name('attendances.datePrintData');
