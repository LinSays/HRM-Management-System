...
@if($print_type == "summary")
    <H2>Summary Attendance Print</H2>
    <div class="white-box">
        <div class="table-responsive tableFixHead">
            <table class="table table-nowrap mb-0">
                ...
                @foreach($employeeAttendence as $key => $attendance)
                    ...
                    @endphp
                    <tr>
                        <td class="table-col"> {!! end($attendance) !!} </td>
...
@elseif($print_type == "member")
    <H2>{{$membername}} Attendance Print</H2>
    <table class="table ">
        <thead>
        <tr>
...
@elseif($print_type == "date")
    <H2>{{$date_title}}'s Attendance Report</H2>   
