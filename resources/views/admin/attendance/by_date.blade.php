...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            ...
            class="btn btn-success btn-sm btn-outline pull-right">@lang('modules.attendance.markAttendance') <i class="fa fa-plus" aria-hidden="true"></i></a>
            <div class="pull-right" style="margin-right:20px">
                ...
                <span  id="print" class="btn btn-success btn-sm " onclick="print_date(event.target);">Print</span>
            </div>
            <ol class="breadcrumb">
...
@push('footer-script')
    ...
    <script>
        ...
        var date = $('#attendance_date').val();
        var url = '{!! route('admin.attendances.date.export_csv', [':date',]) !!}';
    ...
    function exportPdf(_this) {
        ...
        var url = '{!! route('admin.attendances.date.export_pdf', [':date',]) !!}';
        url = url.replace(':date', date);
        window.location.href = url;
    }

    function print_date(_this){
        
        var print_ = "";
        var date = $('#attendance_date').val();
        
        var url = '{!! route('admin.attendances.datePrintData') !!}';
